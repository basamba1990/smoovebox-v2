...
INSERT INTO public.skill_compatibility (skill_a_id, skill_b_id, score_p, score_c, score_t, score_d, total_score) VALUES
  ...
  ((SELECT id FROM public.skills WHERE name = 'Organisation'), (SELECT id FROM public.skills WHERE name = 'Gestion de projet'), NULL, NULL, NULL, NULL, 9.7),
  ((SELECT id FROM public.skills WHERE name = 'Organisation'), (SELECT id FROM public.skills WHERE name = 'Leadership'), NULL, NULL, NULL, NULL, 7.2),
  ((SELECT id FROM public.skills WHERE name = 'Organisation'), (SELECT id FROM public.skills WHERE name = 'Résolution de problèmes'), NULL, NULL, NULL, NULL, 7.9),
  ((SELECT id FROM public.skills WHERE name = 'Gestion de projet'), (SELECT id FROM public.skills WHERE name = 'Organisation'), NULL, NULL, NULL, NULL, 5.1),
  ((SELECT id FROM public.skills WHERE name = 'Gestion de projet'), (SELECT id FROM public.skills WHERE name = 'Leadership'), NULL, NULL, NULL, NULL, 8.2),
  ((SELECT id FROM public.skills WHERE name = 'Gestion de projet'), (SELECT id FROM public.skills WHERE name = 'Résolution de problèmes'), NULL, NULL, NULL, NULL, 8),
  ((SELECT id FROM public.skills WHERE name = 'Leadership'), (SELECT id FROM public.skills WHERE name = 'Organisation'), NULL, NULL, NULL, NULL, 4.2),
  ((SELECT id FROM public.skills WHERE name = 'Leadership'), (SELECT id FROM public.skills WHERE name = 'Gestion de projet'), NULL, NULL, NULL, NULL, 5.5),
  ((SELECT id FROM public.skills WHERE name = 'Leadership'), (SELECT id FROM public.skills WHERE name = 'Résolution de problèmes'), NULL, NULL, NULL, NULL, 6.2),
  ((SELECT id FROM public.skills WHERE name = 'Résolution de problèmes'), (SELECT id FROM public.skills WHERE name = 'Organisation'), NULL, NULL, NULL, NULL, 4.9),
  ((SELECT id FROM public.skills WHERE name = 'Résolution de problèmes'), (SELECT id FROM public.skills WHERE name = 'Gestion de projet'), NULL, NULL, NULL, NULL, 5.8),
  ((SELECT id FROM public.skills WHERE name = 'Résolution de problèmes'), (SELECT id FROM public.skills WHERE name = 'Leadership'), NULL, NULL, NULL, NULL, 6.6),
  ...
  ((SELECT id FROM public.skills WHERE name = 'Travail d''équipe'), (SELECT id FROM public.skills WHERE name = 'Écoute'), NULL, NULL, NULL, NULL, 9.7),
  ((SELECT id FROM public.skills WHERE name = 'Travail d''équipe'), (SELECT id FROM public.skills WHERE name = 'Contribution'), NULL, NULL, NULL, NULL, 9.3),
  ((SELECT id FROM public.skills WHERE name = 'Travail d''équipe'), (SELECT id FROM public.skills WHERE name = 'Autonomie'), NULL, NULL, NULL, NULL, 6),
  ((SELECT id FROM public.skills WHERE name = 'Écoute'), (SELECT id FROM public.skills WHERE name = 'Travail d''équipe'), NULL, NULL, NULL, NULL, 5.7),
  ((SELECT id FROM public.skills WHERE name = 'Écoute'), (SELECT id FROM public.skills WHERE name = 'Contribution'), NULL, NULL, NULL, NULL, 8.9),
  ((SELECT id FROM public.skills WHERE name = 'Écoute'), (SELECT id FROM public.skills WHERE name = 'Autonomie'), NULL, NULL, NULL, NULL, 6),
  ((SELECT id FROM public.skills WHERE name = 'Contribution'), (SELECT id FROM public.skills WHERE name = 'Travail d''équipe'), NULL, NULL, NULL, NULL, 5.8),
  ((SELECT id FROM public.skills WHERE name = 'Contribution'), (SELECT id FROM public.skills WHERE name = 'Écoute'), NULL, NULL, NULL, NULL, 8.9),
  ((SELECT id FROM public.skills WHERE name = 'Contribution'), (SELECT id FROM public.skills WHERE name = 'Autonomie'), NULL, NULL, NULL, NULL, 7.1),
  ((SELECT id FROM public.skills WHERE name = 'Autonomie'), (SELECT id FROM public.skills WHERE name = 'Travail d''équipe'), NULL, NULL, NULL, NULL, 6),
  ((SELECT id FROM public.skills WHERE name = 'Autonomie'), (SELECT id FROM public.skills WHERE name = 'Écoute'), NULL, NULL, NULL, NULL, 6),
  ((SELECT id FROM public.skills WHERE name = 'Autonomie'), (SELECT id FROM public.skills WHERE name = 'Contribution'), NULL, NULL, NULL, NULL, 7.1);
