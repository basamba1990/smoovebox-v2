...
Deno.serve(async (req) => {
  ...
  try {
      ...
      try {
        ...
        return new Response(
          JSON.stringify({
            ...
            context: { bucket, originalPath: (video as any).storage_path, processedPath: filePath }
          }),
    ...
    const responsePromise = new Response(
      JSON.stringify({ success: true, message: 'Transcription démarrée avec succès', videoId }),
