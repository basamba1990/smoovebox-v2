...
const AuthModal = ({ isOpen, onClose, onAuthSuccess }) => {
    ...
    try {
      ...
      if (errorMessage.includes("Email ou mot de passe incorrect") && isLogin) {
        setTimeout(() => {
          setError(
            errorMessage +
              ' - Vous pouvez également créer un nouveau compte en cliquant sur "Pas de compte ? Inscrivez-vous"'
          );
        }, 2000);
      }
    } finally {
  ...
  return (
    ...
    >
      <DialogContent className="w-full  !max-w[320px] mx-auto">
        {showConfirmation ? (
          <>
            <DialogHeader>
            ...
            <div className="py-6 text-center space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm text-blue-800">
                💡 <strong>Astuce :</strong> Vérifiez aussi votre dossier spam
